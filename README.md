...
my-90-days-of-cybersecurity/
├── README.md
├── notes/          → daily/weekly write-ups in my own words
├── labs/            → screenshots, pcap files, configs from hands-on exercises
└── projects/         → mini builds along the way
```
...
## 🧪 Labs
Hands-on exercises — packet captures, VM setups, configs, and annotated screenshots from practical work.

## 🛠 Projects
Any mini-projects built along the way, especially where topics connect to my existing work like [Checkpoint](#) (URL Safety Checker).

---

## 📚 Resources
- **Source roadmap:** [90DaysOfCyberSecurity by farhanashrafdev](https://github.com/farhanashrafdev/90DaysOfCyberSecurity)
- Professor Messer's Network+ (N10-009) and Security+ (SY0-701) playlists
